            ...
            <div class="box-body">
              ...
              <br/>
                ...
                <div class="col-sm-12" style="border-bottom: 1px solid #6d7177;padding-bottom: 10px; padding-top: 10px;">
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <input type="text" style="text-align: right; font-size:20px; " class="form-control" id="bayar" name="bayar" placeholder="Masukkan" required="" />
                  </div>
                </div>
  ...
  function addDetailPemesanan()
    {
      ...
      $.ajax({
        type:'POST',
        url: url,
        data:"id_produk="+id_produk+"&qty_beli="+qty+"&harga="+harga,
        dataType: "JSON",
          ...
          success: function(data){
            ...
            if(data.length > 0){
              ...
              $.each(data, function(key, value) {
                ...
                $("#dataDetail").append(
                '<h4>'+value['nama_produk']+' - Rp '+value['harga']+'</h4>'
                +'<div class="row">'
                  +'<div class="col-md-4">'
                    +'<div class="form-group">'
                      +'<label>Qty</label>'
                      +'<input type="hidden" value="'+value['id_produk']+'" id="id_produk_modal" name="id_produk_modal" class="form-control" />'
                       +'<input type="hidden" value="'+value['harga']+'" id="harga_modal" name="harga_modal" class="form-control" />'
      ...
      $.ajax({
          ...
          success: function(data){
            ...
            if(data.length > 0){
              ...
              $.each(data, function(key, value) {
                no++;
                sub_total = sub_total + (value['qty_beli'] * value['sub_total']);
                pajak = 0.1 * sub_total;
                ...
                '<tr>'                  
                  ...
                  +'<td><font class="pull-left">'+value['sub_total']+'</font></td>'
