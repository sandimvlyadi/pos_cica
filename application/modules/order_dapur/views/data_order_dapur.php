    ...
    <div class="box box-danger">
      <div class="box-header with-border">
        <div class="dropdown">
          ...
          <ul class="dropdown-menu" style="margin-left: 42.5px">
            <li><a href="<?php echo site_url('order_dapur/export_bulan'); ?>" target="_blank">Perbulan</a></li>
            <li><a href="<?php echo site_url('order_dapur/export_triwulan'); ?>" target="_blank">Triwulan</a></li>
            <li><a href="<?php echo site_url('order_dapur/export_tahun'); ?>" target="_blank">Tahun</a></li>
          </ul>
        </div>
          ...
          <table class="table nameTable table-bordered">
              ...
              <tr>
                ...
                <td width="10%" align="center"><!-- <a class="btn btn-primary btn-xs" href="<?=base_url();?>order/edit/<?=$v->id_pemesanan;?>" title="Edit Data"><i class="fa fa-pencil"></i></a> -->
                  <a class="btn btn-success btn-xs" href="<?=base_url();?>order_dapur/detail/<?=$v->id_pemesanan;?>" title="Edit Data"><i class="fa fa-list"></i>
                  <!-- </a>
