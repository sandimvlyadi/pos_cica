  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li class="header">LAPORAN</li>
        <li><a href="<?=base_url();?>laporan"><i class="fa fa-circle-o"></i> <span>Transaksi Penjualan</span></a></li>
        <li><a href="<?=base_url();?>laporan"><i class="fa fa-circle-o"></i> <span>Pembelian Bahan Baku</span></a></li>
        <li><a href="<?=base_url();?>laporan"><i class="fa fa-circle-o"></i> <span>Bahan Baku Keluar</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
