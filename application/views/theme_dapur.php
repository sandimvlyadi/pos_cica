    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          <li class="dropdown">
           <a href="#" class="dropdown-toggle notif" data-toggle="dropdown"><span class="label label-pill label-danger count" style="border-radius:10px;"></span> <span class="fa fa-bell" style="font-size:18px;"></span></a>
           <ul class="dropdown-menu notif-list"></ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li class="header">MENU</li>
        <!--
        <li class="active">
            <a href="<?=site_url();?>order_dapur/index/">
        ...
        -->
        <li class="active"><a href="<?=base_url();?>kategori"><i class="fa fa-circle-o"></i> <span>Kategori</span></a></li>
        <li class="active"><a href="<?=base_url();?>produk"><i class="fa fa-circle-o"></i> <span>Produk</span></a></li>
        <li class="active"><a href="<?=base_url();?>promo"><i class="fa fa-circle-o"></i> <span>Promo</span></a></li>
...
<script>
  $(document).ready(function(){
    function load_unseen_notification(view = '')
     {
      url = "<?php echo site_url();?>order_dapur/notif";
      $.ajax({
       url:url,
       method:"POST",
       data:{view:view},
