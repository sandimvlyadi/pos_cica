          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6" id="div_potongan_harga" style="display: none;">
						...
						<div class="form-group">
							<input type="text" name="potongan_harga" value="<?php echo $this->input->post('potongan_harga'); ?>" class="form-control" id="potongan_harga" />
						</div>
					</div>
					<div class="col-md-6" id="div_diskon" style="display: none;">
						<label for="diskon" class="control-label">Diskon</label>
						<div class="input-group">
			            	<input type="text" name="diskon" value="<?php echo $this->input->post('diskon'); ?>" class="form-control" id="diskon" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="date" name="start_date" value="<?php echo $this->input->post('start_date'); ?>" class="has-datepicker form-control" id="start_date" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="end_date" class="control-label">End Date</label>
						<div class="form-group">
							<input type="date" name="end_date" value="<?php echo $this->input->post('end_date'); ?>" class="has-datepicker form-control" id="end_date" />
						</div>
					</div>
					<div class="col-md-6">
