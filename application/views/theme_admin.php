...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li><a href="<?=base_url();?>Kategori"><i class="fa fa-circle-o"></i> <span>Kategori</span></a></li>
        <li><a href="<?=base_url();?>produk"><i class="fa fa-circle-o"></i> <span>Produk</span></a></li>
        <li><a href="<?=base_url();?>promo"><i class="fa fa-circle-o"></i> <span>Promo</span></a></li>
        <li><a href="<?=base_url();?>bahan"><i class="fa fa-circle-o"></i> <span>Bahan Baku</span></a></li>
